...
Usage:
    python src/scripts/research_topics.py            # default: 12 topics
    python src/scripts/research_topics.py --target 20     # more topics
    python src/scripts/research_topics.py --no-miner      # skip channel mining
"""
