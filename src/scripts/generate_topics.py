...
Usage:
    python src/scripts/generate_topics.py            # default: limit=100 per source
    python src/scripts/generate_topics.py --limit 10 # smaller pulls for quick testing
    python src/scripts/generate_topics.py --target 20
"""
