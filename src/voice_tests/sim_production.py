...
Usage:
    uv run python src/voice_tests/sim_production.py [--voices donald-trump arnold-schwarzenegger] [--seed N] [--workers 2]

Output lands in src/voice_tests/audio/sim_production/<voice_id>/<line_id>.wav
