...
Usage:
    python src/voices_to_clone/build_clone_ref.py donald-trump src/voices_to_clone/trump_voice_to_clone.mp3
    python src/voices_to_clone/build_clone_ref.py arnold-schwarzenegger src/voices_to_clone/arnold_voice_to_clone.wav --prime-start 0 --prime-end 0
    python src/voices_to_clone/build_clone_ref.py <voice_id> <source> --out custom.wav --keep-all
"""
import argparse
import os
import subprocess
...
def main():
    ...
    out_path = Path(args.out) if args.out else (
        Path("src/voices_to_clone/candidates") / args.voice_id / f"{args.voice_id}_ref.wav")
