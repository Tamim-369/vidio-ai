...
Usage:
    python src/voices_to_clone/speaker_filter_ref.py arnold-schwarzenegger \
        src/voices_to_clone/arnold_voice_to_clone.wav
    python src/voices_to_clone/speaker_filter_ref.py donald-trump \
        src/voices_to_clone/trump_voice_to_clone.mp3 --analyze-only
"""
import argparse
import os
import subprocess
