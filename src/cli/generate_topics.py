...
Usage:
    python src/cli/generate_topics.py            # default: limit=100 per source
    python src/cli/generate_topics.py --limit 10 # smaller pulls for quick testing
    python src/cli/generate_topics.py --target 20
"""
...
from src.agents.topic.generator import run_topic_generation
