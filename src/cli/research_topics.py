...
Usage:
    python src/cli/research_topics.py            # default: 12 topics
    python src/cli/research_topics.py --target 20     # more topics
    python src/cli/research_topics.py --no-miner      # skip channel mining
"""
...
from src.agents.research.agent import run_research_pipeline
...
def main():
    ...
    if args.no_miner:
        ...
        import src.agents.research.agent as ra
        ra.fetch_channel_candidates = lambda **kw: []
